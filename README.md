...
C Trace is an interactive, visual C code execution tracker built to help you understand what your code is doing. Paste C code, hit run, and watch your variables, call stack, and memory change in real time.
